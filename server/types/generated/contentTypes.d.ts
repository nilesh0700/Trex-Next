...
export interface ApiEventCategoryEventCategory
  ...
  info: {
    description: 'Event categories for organizing events';
...
export interface ApiNewsNews extends Struct.CollectionTypeSchema {
  collectionName: 'news';
  info: {
    description: 'News articles with rich content and multiple image support';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    content: Schema.Attribute.RichText & Schema.Attribute.Required;
    content_blocks: Schema.Attribute.Component<
    ...
    news_category: Schema.Attribute.Enumeration<
      ['latest-news', 'business-insights', 'featured']
    > &
      Schema.Attribute.Required &
    ...
    readTime: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'5 min read'>;
    related_news: Schema.Attribute.Relation<'manyToMany', 'api::news.news'>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tags: Schema.Attribute.JSON;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiOrganizerOrganizer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Event organizers information';
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    author_company: Schema.Attribute.String & Schema.Attribute.Required;
    author_image: Schema.Attribute.Media<'images'>;
    author_name: Schema.Attribute.String & Schema.Attribute.Required;
    author_title: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
